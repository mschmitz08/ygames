...
<body>
<applet code="y.k.YahooCheckers" name="ygames_applet" codebase="/ny/" archive="downloads/ygames_launcher_windows/app/newyahoo/client.jar<%=clientJarCacheToken%>" width="100%" height="100%">
