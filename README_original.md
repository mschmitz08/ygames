# this is the read me file from the original author https://github.com/sharivan/ny
...
This project depends on a Tomcat server and a MySQL server to works. The database configuration can be done using the two files database\_creation.sql and mysql\_user\_creation.sql.
